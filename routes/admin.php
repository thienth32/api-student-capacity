...
Route::group([
    ...
    Route::prefix('candidates')->group(function () {
        ...
        Route::post('change-status', [CandidateController::class, 'changStatus'])->name('admin.candidate.changeStatus');
        Route::post('change-result', [CandidateController::class, 'changResult'])->name('admin.candidate.changeResult');
