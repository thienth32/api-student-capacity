                    ...
                    <div class="row g-3 g-lg-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    <!--begin::Number-->
                                    <span class="text-gray-700 fw-boldest d-block fs-2qx lh-1 mb-1">{{number_format($totalContestGoingOn, 0)}}</span>
                                    <!--end::Number-->
                                    <!--begin::Desc-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    <!--begin::Number-->
                                    <span class="text-gray-700 fw-boldest d-block fs-2qx lh-1 mb-1">{{$totalTeamActive}}</span>
                                    <!--end::Number-->
                                    <!--begin::Desc-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    <!--begin::Number-->
                                    <span class="text-gray-700 fw-boldest d-block fs-2qx lh-1 mb-1">{{$totalStudentAccount}}</span>
                                    <!--end::Number-->
                                    <!--begin::Desc-->
        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
                ...
                <div class="card-toolbar">
                    ...
                    <input class="form-control form-control-solid" placeholder="Pick date rage" id="daterange_picker_chart"/>
                    <!--end::Daterangepicker-->
                </div>
                <!--end::Toolbar-->
            </div>
