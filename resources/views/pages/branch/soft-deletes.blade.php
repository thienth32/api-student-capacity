                    ...
                    <div class="col-lg-12">
                        <ol class="breadcrumb text-muted fs-6 fw-bold">
                            <li class="breadcrumb-item pe-3">
                                <a href="{{ route('admin.branch.list') }}" class="pe-3">Quản lý cơ sở
                                </a>
                            </li>
                        ...
                        <tr>
                            @if (request()->has('sort'))
                                <th scope="row">
                                    ...
                                    @else
                                        {{ request()->has('page') && request('page') !== 1? $total - $branches->perPage() * (request('page') - 1) - $key: ($total -= 1) }}
                                    @endif
                                </th>
                            @else
                                <th scope="row">
                            ...
                            <td>
                                {{ date('d-m-Y H:i', strtotime($branch->deleted_at)) }}
                                <br>
                                {{ \Carbon\Carbon::parse($branch->deleted_at)->diffforHumans() }}
                            </td>
                            ...
                            <td>
                                <div class="btn-group dropstart">
                                    ...
                                    <ul class="dropdown-menu px-4">
                                        <li class="my-3">
                                            <a href="{{ route('admin.branch.soft.restore', ['slug' => $branch->slug]) }}">
...
{{--                                                    href="{{ route('admin.branch.soft.deletes', ['slug' => $branch->slug]) }}">--}}
