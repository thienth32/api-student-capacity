...
@section('title', 'Danh sách các bài tuyển dụng đã xóa ')
                    ...
                    @if (count($listSofts) > 0)
                        @foreach ($listSofts as $key => $listSoft)
                            <tr>
                                ...
                                <td>
                                    {{ date('d-m-Y H:i', strtotime($listSoft->start_time)) }}
                                    <br>
                                    {{ \Carbon\Carbon::parse($listSoft->start_time)->diffforHumans() }}
                                </td>
                                <td>
                                    {{ date('d-m-Y H:i', strtotime($listSoft->end_time)) }}
                                    <br>
                                ...
                                <td>
                                    <div class="btn-group dropstart">
                                        ...
                                        <ul class="dropdown-menu px-4 ">
                                            ...
                                            <li class="my-3">
                                                <a
                                                    href="{{ route('admin.recruitment.soft.deletes', ['id' => $listSoft->id]) }}">
