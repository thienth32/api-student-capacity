                            ...
                            @foreach ($round as $item)
                                <tr>
                                    ...
                                    <td><img class='w-100px'
                                            src="{{ Storage::disk('google')->has($item->Enterprise->logo)? Storage::disk('google')->url($item->Enterprisem->logo): 'https://skillz4kidzmartialarts.com/wp-content/uploads/2017/04/default-image.jpg' }}"
                                            alt=""></td>
