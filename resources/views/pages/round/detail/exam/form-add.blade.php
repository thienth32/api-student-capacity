...
@section('page-title', 'Thêm đề thi ')
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="max_ponit" id="" class="form-control" placeholder="">
                                @error('max_ponit')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="ponit" id="" class="form-control" placeholder="">
                                @error('ponit')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
