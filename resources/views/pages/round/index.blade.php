        ...
        <div class="col-lg-12 ">
            <div class="card card-flush p-5">
                <div class=" d-flex justify-content-start align-self-start">
                    ...
                    <div class="ms-3">
                        <span role="button" class="py-3 pb-2 pt-1 refresh-btn svg-icon svg-icon-primary svg-icon-2x">
                    ...
                    <div>
                        <a class="ps-3 pb-2 pt-1" href="{{ route('admin.round.soft.delete', 'round_soft_delete=1') }}">
                                        ...
                                        <div style="{{ (request()->has('day') || request()->has('month') || request()->has('year')) && request()->has('op_time')? '': 'display : none' }}"
                                            ...
                                            <div class="col-12  ">
                                                ...
                                                <select class="select-date-serach form-control">
                                                    ...
                                                    <option class="form-control" @selected(request('day') == 7 && request('op_time') == 'add')
                                                        value="add-day-7">7 Ngày
                                                        tới
                                                    </option>
                                                    <option class="form-control" @selected(request('day') == 15 && request('op_time') == 'add')
                                                        value="add-day-15">15
                                                        Ngày
                                                        tới </option>
                                                    <option class="form-control" @selected(request('month') == 1 && request('op_time') == 'add')
                                                        value="add-month-1">1
                                                        Tháng
                                                        tới
                                                    </option>
                                                    <option class="form-control" @selected(request('month') == 6 && request('op_time') == 'add')
                                                        value="add-month-6">6
                                                        Tháng
                                                        tới
                                                    </option>
                                                    <option class="form-control" @selected(request('year') == 1 && request('op_time') == 'add')
                                                        value="add-year-1">1 Năm
                                                        tới
                                                    </option>
                                                    <option class="form-control" disabled> </option>
                                                    <option class="form-control" @selected(request('day') == 7 && request('op_time') == 'sub')
                                                        value="sub-day-7">7 Ngày
                                                        trước </option>
                                                    <option class="form-control" @selected(request('day') == 15 && request('op_time') == 'sub')
                                                        value="sub-day-15">15
                                                        Ngày
                                                        trước
                                                    </option>
                                                    <option class="form-control" @selected(request('month') == 1 && request('op_time') == 'sub')
                                                        value="sub-month-1">1
                                                        Tháng
                                                        trước
                                                    </option>
                                                    <option class="form-control" @selected(request('month') == 6 && request('op_time') == 'sub')
                                                        value="sub-month-6">6
                                                        Tháng
                                                        trước
                                                    </option>
                                        ...
                                        <div class="col-lg-12 col-lg-4 col-sx-12 col-md-12 col-sm-12 col-xxl-4 col-xl-4">
                                            <div class="  form-group ">
                                                ...
                                                <select id="select-type-exam"
                                                    ...
                                                    @forelse ($type_exams as $type_exam)
                                                        <option @selected(request('type_exam_id') == $type_exam->id)
                                                            value="{{ $type_exam->id }}">
                                                            {{ $type_exam->name }}
                                                        </option>
                                                    @empty
                                                ...
                                                <div style="{{ (request()->has('day') || request()->has('month') || request()->has('year')) && request()->has('op_time')? '': 'display : none' }}"
                                                    ...
                                                    <div class="col-12  ">
                                                        ...
                                                        <select
                                                            ...
                                                            <option class="form-control" @selected(request('year') == 1 && request('op_time') == 'sub')
                                                                value="sub-year-1">1
                                                                Năm
                                                                trước
                                                            </option>
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($rounds as $key => $round)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ route('admin.round.detail', ['id' => $round->id]) }}">
                                                                {{ $round->name }}
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group dropstart">
                                                                ...
                                                                <ul class="dropdown-menu ps-3">
                                                                    <li class="my-3">
                                                                        <a
                                                                            href="{{ route('admin.round.edit', ['id' => $round->id]) }}">
                                                                            <span role="button"
