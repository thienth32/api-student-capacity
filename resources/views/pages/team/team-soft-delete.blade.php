                                                    ...
                                                    <div class="row">
                                                        <div class="col md-6">
                                                            <img style="width:200px;height:200px"
                                                                src="{{ Storage::disk('google')->has($listTeamSoft->image)? Storage::disk('google')->url($listTeamSoft->image): 'https://skillz4kidzmartialarts.com/wp-content/uploads/2017/04/default-image.jpg' }}"
                                                                alt="">
                                                            <h4 class="mt-3">Ngày Tạo : {{ $listTeamSoft->created_at }}
                                                            </h4>
                                                            <h5>Tham gia cuộc thi
                                                                :{{ $listTeamSoft->contest->name ?? 'Chưa có cuộc thi ' }}</h5>
                                                        </div>
                                                        <div class="col md-6">
