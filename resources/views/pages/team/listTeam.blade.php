            ...
            <div class="col-12 col-lg-4 col-sx-12 col-md-12 col-sm-12 col-xxl-4 col-xl-4">
                <div class="form-group p-2">
                    ...
                    <select id="select-date-serach" class="select-date-serach form-control">
                        <option value="/" class="form-control">---- Thời gian ----</option>
                        <option class="form-control" @selected(request('day') == 7) value="day-7">7 Ngày trước </option>
                        <option class="form-control" @selected(request('day') == 14) value="day-14">14 Ngày trước </option>
                        <option class="form-control" @selected(request('day') == 30) value="day-30">30 Ngày trước </option>
                        <option class="form-control" @selected(request('day') == 60) value="day-60">60 Ngày trước </option>
                        <option class="form-control" @selected(request('day') == 90) value="day-90">90 Ngày trước</option>
                    </select>
                </div>
