        ...
        <div class="col-lg-6">
            <div class="d-flex justify-content-start">
                ...
                <a class="mx-2" href="{{ route('admin.candidate.list') }}">
                    <span data-bs-toggle="tooltip" title="Tải lại trang " role="button" class="refresh-btn svg-icon svg-icon-primary svg-icon-2x">
                ...
                <a class="mx-2" href="{{ route('admin.candidate.list.soft.deletes', 'candidate_soft_delete=1') }}">
                    ...
                    <span data-bs-toggle="tooltip" title="Kho lưu trữ bản xóa " class=" svg-icon svg-icon-primary svg-icon-2x">
                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Files/Deleted-folder.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
...
<div class="row card-format">
    <div class="col-12 col-lg-4 col-sx-12 col-md-12 col-sm-12 col-xxl-4 col-xl-4">
        <div class="form-group p-2">
            ...
            <select id="select-code-recruitment" class="form-select mb-2 select2-hidden-accessible" name="post_id" data-control="select2" data-hide-search="false" tabindex="-1" aria-hidden="true">
    ...
    <div class="col-12 col-lg-4 col-sx-12 col-md-12 col-sm-12 col-xxl-4 col-xl-4">
        <div class="  form-group pt-2">
            <div class="mb-0">
                ...
                <div id="reportrange" style="background: #fff; cursor: pointer; padding: 10px 10px; border: 1px solid #e4e6ef ; width: 100%; border-radius: 7px">
...
<div class="back">
    ...
    <span data-bs-toggle="tooltip" title="Đóng lọc" class="btn-hide svg-icon svg-icon-primary svg-icon-2x">
        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Navigation/Stockholm-icons/Navigation/Angle-up.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <span data-bs-toggle="tooltip" title="Mở lọc" style="display: none" class="btn-show svg-icon svg-icon-primary svg-icon-2x">
        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Navigation/Angle-down.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <polygon points="0 0 24 0 24 24 0 24" />
    ...
    <table class=" table table-hover table-responsive-md ">
            ...
            <tr>
                ...
                <th scope="col">Thời gian ứng tuyển
                    <a data-href="{{ request()->has('sortBy') ? (request('sortBy') == 'desc' ? 'asc' : 'desc') : 'asc' }}" data-order="created_at" id="time_candidate">
                        <span role="button" data-key="name" data-bs-toggle="tooltip" title="Lọc theo thời gian ứng tuyển " class=" svg-icon svg-icon-primary  svg-icon-2x format-database">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn  btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#introduce_{{ $key->id }}">
                        {{ $key->name }}
                    </button>
                ...
                <td>
                    ...
                    <a class="show_file btn btn-primary btn-sm" target="_blank" rel="noopener" href="{{ Storage::disk('s3')->temporaryUrl($key->file_link, now()->addMinutes(5)) }}">Xem</a>
                </td>
...
{{--                        xuống</a>--}}
                    ...
                    <div data-bs-toggle="tooltip" title="Thao tác " class="btn-group dropstart">
                        <button type="button" class="btn   btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="svg-icon svg-icon-success svg-icon-2x">
                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Settings-2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                        ...
                        <ul class="dropdown-menu  px-4 ">
                            ...
                            <li class="my-3">
                                @hasrole('super admin')
                                @if ($key->post->count() == 0)
                                <form action="{{ route('admin.candidate.destroy', $key->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button onclick="return confirm('Bạn có chắc muốn xóa không !')" style=" background: none ; border: none ; list-style : none" type="submit">
                                        <span role="button" class="svg-icon svg-icon-danger svg-icon-2x">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Home/Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
                                ...
                                <div style="cursor: not-allowed; user-select: none">
                                    ...
                                    <span class="svg-icon svg-icon-danger svg-icon-2x">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Code/Lock-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                ...
                <!-- Modal add note -->
                <div class="modal fade" id="add_note_{{ $key->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form action="{{ route('admin.candidate.createNote', ['candidate_id' => $key->id]) }}" method="post">
                        @csrf
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body form-group">
                                    <textarea class="form-control" name="content" required id="" rows="3"></textarea>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Thoát
                                    </button>
                                    <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Lưu và gửi email
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Modal add note -->
                <div class="modal fade" id="list_note_{{ $key->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form action="{{ route('admin.candidate.createNote', ['candidate_id' => $key->id]) }}" method="post">
                        @csrf
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body form-group">
                                    ...
                                    <ul style="list-style: none;">
                                        <li>
                                            <b>{{$idx + 1}}. {{ date('d-m-Y H:i', strtotime($note->created_at)) }} - {{$note->user->email}}</b>
                                            <p>{{$note->content}}</p>
                                        </li>
                                    </ul>
                                    @endforeach
