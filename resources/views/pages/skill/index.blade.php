    ...
    <div class="card card-flush p-4">
        <div class="row">
            <div class="col-lg-6">
                <div class="d-flex justify-content-start">
                    ...
                    <a class="mx-2" href="{{ route('admin.skill.soft.delete', 'skill_soft_delete=1') }}">
            ...
            <div class=" col-lg-6">
                <div class=" d-flex flex-row-reverse bd-highlight">
                    ...
                    <a href="{{ route('admin.skill.create') }}" class=" btn btn-primary">Tạo mới kĩ năng
                    </a>
                </div>
            </div>
        </div>
        <div class="row card-format">
            ...
            <div class="col-12 col-lg-4 col-sx-12 col-md-12 col-sm-12 col-xxl-4 col-xl-4">
                <div class="form-group p-2">
                    <label class="form-label">Danh sách chuyên ngành </label>
        ...
        <div class="table-responsive p-4 card card-flush ">
            ...
            @if (count($dataSkill) > 0)
                                ...
                                <td>
                                    <div data-bs-toggle="tooltip" title="Thao tác " class="btn-group dropstart">
                                        ...
                                        <ul class="dropdown-menu  px-4 ">
                                            <li class="my-3">
                                                <a href="{{ route('admin.skill.edit', $key->id) }}">
                                            ...
                                            <li class="my-3">
                                                @hasrole('super admin')
                                                    @if ($key->majorSkill->count() == 0 && $key->questions->count() == 0)
                                                        <form action="{{ route('admin.skill.destroy', $key->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                ...
                {{ $dataSkill->appends(request()->all())->links('pagination::bootstrap-4') }}
            @else
                <h2>Không tìm thấy kỹ năng !!!</h2>
            @endif
        ...
        $(document).ready(function() {
            ...
            $('#searchTeam').keypress(function(event) {
                ...
                if (keycode == '13') {
                    let key = $(this).val();
                    // alert(key)
                    window.location = 'admin/skill?keyword=' + key;
                }
            });
        })
    </script>
