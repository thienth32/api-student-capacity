                        ...
                        <div class="col-lg-4">
                            <div class="form-group ">
                                ...
                                <img class="w-100 mt-4 border rounded-3" id="image-preview"
                                    src="{{ Storage::disk('s3')->has($team->image ?? 'Default') ? Storage::disk('s3')->temporaryUrl($team->image, now()->addMinutes(5)) : 'https://vanhoadoanhnghiepvn.vn/wp-content/uploads/2020/08/112815953-stock-vector-no-image-available-icon-flat-vector.jpg' }} " />
                            </div>
                        </div>
                    </div>
