            ...
            @hasanyrole(config('util.ROLE_ADMINS') . '|judge')
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Quản lý test năng lực </span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link"
                                href="{{ route('admin.contest.list') . '?type=' . config('util.TYPE_TEST') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Danh sách test năng lực</span>
                            </a>
                        </div>
                        {{--  --}}
                        @hasanyrole(config('util.ROLE_ADMINS'))
                            <div class="menu-item">
                                <a class="menu-link"
                                    href="{{ route('admin.contest.create') . '?type=' . config('util.TYPE_TEST') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Thêm mới test năng lực </span>
                                </a>
                            </div>
                        @endhasrole
                    </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('admin.recruitment.list') }}">
                                ...
                                <span class="menu-title">Danh sách tuyển dụng </span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('admin.recruitment.create') }}">
                                ...
                                <span class="menu-title">Thêm mới tuyển dụng </span>
                            </a>
                        </div>
