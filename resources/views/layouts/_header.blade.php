...
{{--                        </div>--}}
    ...
    {{--    Support     --}}
    <div id="kt_drawer_chat" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="chat" data-kt-drawer-activate="true" data-kt-drawer-overlay="false" data-kt-drawer-width="{default:'300px', 'md': '500px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_drawer_chat_toggle" data-kt-drawer-close="#kt_drawer_chat_close">
        <!--begin::Messenger-->
            ...
            <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">Admin</a>
                        <!--begin::Info-->
                        <div class="mb-0 lh-1">
                    ...
                    @foreach(array_reverse(session('url-history')) as $history)
                        <div class="d-flex justify-content-end mb-10">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                ...
                                >Bạn đã truy cập <a href=" {{ $history['url'] }}">  {{ $history['url'] }}</a> </div>
                                <!--end::Text-->
                            </div>
