...
Route::get('rounds', [RoundController::class, 'apiIndex']);
Route::put('rounds/{id}', [RoundController::class, 'apiUpdate']);
Route::delete('rounds/{id}', [RoundController::class, 'apiDestroy']);