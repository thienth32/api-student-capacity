...
Route::prefix('rounds', function () {
    Route::get('', [RoundController::class, 'apiIndex'])->name('round.index');
    Route::put('/{id}', [RoundController::class, 'apiUpdate'])->name('round.update');
    Route::delete('/{id}', [RoundController::class, 'apiDestroy'])->name('round.delete');
});