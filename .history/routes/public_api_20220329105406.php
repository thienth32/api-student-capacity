...
Route::get('rounds', [RoundController::class, 'apiIndex'])->name('round.index');
Route::put('rounds/{id}', [RoundController::class, 'apiUpdate'])->name('round.update');
Route::delete('rounds/{id}', [RoundController::class, 'apiDestroy'])->name('round.delete');